...
@pytest.mark.asyncio
async def test_create_note(create_note_data: CreateNote, return_note_model: Note, mocker: MockerFixture, db_session: Session):
    mocker.patch("microservice_template.db.db.create", return_value=return_note_model)
    new_note = await db_create_note(create_note_data, db_session)
